...
GOVERNANCE_GATEWAY_URL=${governance_gateway_url}
GOVERNANCE_CONTROL_BUCKET=${governance_control_bucket}
GOVERNANCE_JDBC_DRIVER_OBJECT=${governance_jdbc_driver_object}
