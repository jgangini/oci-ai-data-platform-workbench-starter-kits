...
EXPECTED_REFS = frozenset({"v2.0.0-rc.1", "v2.0.0-rc.2", "v2.0.0-rc.3", "v2.0.0-rc.4", "v2.0.0"})
...
def validate_context(context: dict[str, Any]) -> None:
    ...
    if source.get("ref") not in EXPECTED_REFS:
        raise ValueError(
            "release requires source ref v2.0.0-rc.1, v2.0.0-rc.2, v2.0.0-rc.3, v2.0.0-rc.4, or v2.0.0"
        )
